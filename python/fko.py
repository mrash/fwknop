...
FKO_ERROR_INVALID_DATA_RAND_MODE_VALIDFAIL = 85
FKO_ERROR_INVALID_DATA_SRVAUTH_MISSING = 86
FKO_ERROR_INVALID_DATA_TIMESTAMP_VALIDFAIL = 87
FKO_ERROR_INVALID_DATA_USER_MISSING = 88
FKO_ERROR_INVALID_DATA_USER_FIRSTCHAR_VALIDFAIL = 89
FKO_ERROR_INVALID_DATA_USER_REMCHAR_VALIDFAIL = 90
FKO_ERROR_INVALID_DATA_UTIL_STRTOL_LT_MIN = 91
FKO_ERROR_INVALID_DATA_UTIL_STROL_GT_MAX = 92
FKO_ERROR_DATA_TOO_LARGE = 93
FKO_ERROR_INVALID_KEY_LEN = 94
FKO_ERROR_USERNAME_UNKNOWN = 95
FKO_ERROR_INCOMPLETE_SPA_DATA = 96
FKO_ERROR_MISSING_ENCODED_DATA = 97
FKO_ERROR_INVALID_DIGEST_TYPE = 98
FKO_ERROR_INVALID_ALLOW_IP = 99
FKO_ERROR_INVALID_SPA_COMMAND_MSG = 100
FKO_ERROR_INVALID_SPA_ACCESS_MSG = 101
FKO_ERROR_INVALID_SPA_NAT_ACCESS_MSG = 102
FKO_ERROR_INVALID_ENCRYPTION_TYPE = 103
FKO_ERROR_WRONG_ENCRYPTION_TYPE = 104
FKO_ERROR_DECRYPTION_SIZE = 105
FKO_ERROR_DECRYPTION_FAILURE = 106
FKO_ERROR_DIGEST_VERIFICATION_FAILED = 107
FKO_ERROR_INVALID_HMAC_KEY_LEN = 108
FKO_ERROR_UNSUPPORTED_HMAC_MODE = 109
FKO_ERROR_UNSUPPORTED_FEATURE = 110
FKO_ERROR_ZERO_OUT_DATA = 111
FKO_ERROR_UNKNOWN = 112
# Start GPGME-related errors
GPGME_ERR_START = 113
FKO_ERROR_MISSING_GPG_KEY_DATA = 114
FKO_ERROR_GPGME_NO_OPENPGP = 115
FKO_ERROR_GPGME_CONTEXT = 116
FKO_ERROR_GPGME_PLAINTEXT_DATA_OBJ = 117
FKO_ERROR_GPGME_SET_PROTOCOL = 118
FKO_ERROR_GPGME_CIPHER_DATA_OBJ = 119
FKO_ERROR_GPGME_BAD_PASSPHRASE = 120
FKO_ERROR_GPGME_ENCRYPT_SIGN = 121
FKO_ERROR_GPGME_CONTEXT_SIGNER_KEY = 122
FKO_ERROR_GPGME_SIGNER_KEYLIST_START = 123
FKO_ERROR_GPGME_SIGNER_KEY_NOT_FOUND = 124
FKO_ERROR_GPGME_SIGNER_KEY_AMBIGUOUS = 125
FKO_ERROR_GPGME_ADD_SIGNER = 126
FKO_ERROR_GPGME_CONTEXT_RECIPIENT_KEY = 127
FKO_ERROR_GPGME_RECIPIENT_KEYLIST_START = 128
FKO_ERROR_GPGME_RECIPIENT_KEY_NOT_FOUND = 129
FKO_ERROR_GPGME_RECIPIENT_KEY_AMBIGUOUS = 130
FKO_ERROR_GPGME_DECRYPT_FAILED = 131
FKO_ERROR_GPGME_DECRYPT_UNSUPPORTED_ALGORITHM = 132
FKO_ERROR_GPGME_BAD_GPG_EXE = 133
FKO_ERROR_GPGME_BAD_HOME_DIR = 134
FKO_ERROR_GPGME_SET_HOME_DIR = 135
FKO_ERROR_GPGME_NO_SIGNATURE = 136
FKO_ERROR_GPGME_BAD_SIGNATURE = 137
FKO_ERROR_GPGME_SIGNATURE_VERIFY_DISABLED = 138
